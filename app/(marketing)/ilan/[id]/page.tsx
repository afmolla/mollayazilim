...
export default async function IlanDetayPage({ params }: Props) {
  ...
  return (
    <div className="bg-[#ebebeb] pb-16 pt-6 md:pt-8">
      <div className="mx-auto max-w-6xl px-4 md:px-6">
      <nav className="rounded-lg border border-[#ddd] bg-white px-4 py-3 text-sm text-[var(--muted)] shadow-sm">
      ...
      <div className="mt-8 grid gap-10 lg:grid-cols-[1.15fr_1fr] lg:items-start">
        <div className="overflow-hidden rounded-2xl border border-[var(--border)] bg-[var(--surface)] shadow-[var(--emlak-shadow)]">
